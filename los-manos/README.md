...
~~~sh
# getting the code
git clone git@github.com:nko4/los-manos.git && cd ./los-manos/

# developing
npm install
npm start

# deploying (to http://los-manos.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@los-manos.2013.nodeknockout.com
ssh root@los-manos.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@los-manos.2013.nodeknockout.com
ssh -i ./id_deploy root@los-manos.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/los-manos" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
